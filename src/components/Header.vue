    ...
    <div class="flex h-16 items-center justify-between px-4 lg:px-8">
      ...
      <nav class="flex items-center gap-6">
        ...
        <Dropdown ref="productDropdown" contentClasses="w-56 left-0 right-auto">
          <template #trigger>
            <button
                class="relative flex items-center gap-1 text-sm font-semibold tracking-tight uppercase transition-colors text-black hover:text-neutral-400"
            >
        ...
        <router-link to="/customer-orders" class="group relative flex items-center gap-1 text-sm font-semibold tracking-tight uppercase transition-colors text-black hover:text-neutral-400">
          Customer Orders
        </router-link>

        <router-link to="/inventory" class="group relative flex items-center gap-1 text-sm font-semibold tracking-tight uppercase transition-colors text-black hover:text-neutral-400">
          Inventory
        </router-link>

        <router-link to="/customers" class="group relative flex items-center gap-1 text-sm font-semibold tracking-tight uppercase transition-colors text-black hover:text-neutral-400">
          Customers
        </router-link>
          ...
          <template #content>
            ...
            <div class="py-1">
              <a
                  ...
                  :key="item.label"
                  href="#"
                  class="flex items-center gap-3 px-4 py-2.5 text-sm text-black hover:text-black hover:bg-slate-700/50 transition-colors duration-150 group"
              >
